...
data class RelatedProducts(var PRODUCT_ID:String,var SHOP_ID:String,var PRODUCT_NAME:String,var PRODUCT_DESC:String,var PRODUCT_PRICE:String,var PRODUCT_STOCK: String,var PRODUCT_IMAGE:String)