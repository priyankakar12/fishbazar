...
class AddAddressViewModl (val appRepository: AppRepository) : ViewModel(){
    ...
    fun addAddressResponse(userid: String,name: String,address_one: String,address_two:String,pincode:String,phone_number:String) =
        addAddressData(userid,name,address_one,address_two,pincode,phone_number)

    fun addAddressData(userid: String,name: String,address_one: String,address_two:String,pincode:String,phone_number:String){
        _userResponse.postValue(Event(Resource.Loading()))
        try{
            disposable.add(appRepository.addnewAddress(userid,name,address_one,address_two,pincode,phone_number).subscribeOn(
